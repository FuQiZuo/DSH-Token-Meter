window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region ../../../node_modules/.pnpm/gpt-tokenizer@4.0.0/node_modules/gpt-tokenizer/esm/constants.js
		const DEFAULT_MERGE_CACHE_SIZE = 1e5;
		//#endregion
		//#region ../../../node_modules/.pnpm/gpt-tokenizer@4.0.0/node_modules/gpt-tokenizer/esm/specialTokens.js
		...
		//#endregion
		//#region ../../../node_modules/.pnpm/gpt-tokenizer@4.0.0/node_modules/gpt-tokenizer/esm/utfUtil.js
		...
		//#endregion
		//#region ../../../node_modules/.pnpm/gpt-tokenizer@4.0.0/node_modules/gpt-tokenizer/esm/util.js
		...
		//#endregion
		//#region ../../../node_modules/.pnpm/gpt-tokenizer@4.0.0/node_modules/gpt-tokenizer/esm/BytePairEncodingCore.js
		...
		//#endregion
		//#region ../../../node_modules/.pnpm/gpt-tokenizer@4.0.0/node_modules/gpt-tokenizer/esm/functionCalling.js
		const NEWLINE = "\n";
...
${" ".repeat(indent)}}`;
		...
		//#endregion
		//#region ../../../node_modules/.pnpm/gpt-tokenizer@4.0.0/node_modules/gpt-tokenizer/esm/modelsChatEnabled.gen.js
		...
		//#endregion
		//#region ../../../node_modules/.pnpm/gpt-tokenizer@4.0.0/node_modules/gpt-tokenizer/esm/_virtual/_rolldown/runtime.js
		...
		//#endregion
		//#region ../../../node_modules/.pnpm/gpt-tokenizer@4.0.0/node_modules/gpt-tokenizer/esm/modelsMap.js
		...
		//#endregion
		//#region ../../../node_modules/.pnpm/gpt-tokenizer@4.0.0/node_modules/gpt-tokenizer/esm/mapping.js
		/**
		...
		*/
		...
		//#endregion
		//#region ../../../node_modules/.pnpm/gpt-tokenizer@4.0.0/node_modules/gpt-tokenizer/esm/encodingParams/constants.js
		...
		//#endregion
		//#region ../../../node_modules/.pnpm/gpt-tokenizer@4.0.0/node_modules/gpt-tokenizer/esm/encodingParams/cl100k_base.js
		...
		//#endregion
		//#region ../../../node_modules/.pnpm/gpt-tokenizer@4.0.0/node_modules/gpt-tokenizer/esm/encodingParams/o200k_base.js
		...
		//#endregion
		//#region ../../../node_modules/.pnpm/gpt-tokenizer@4.0.0/node_modules/gpt-tokenizer/esm/encodingParams/o200k_harmony.js
		...
		//#endregion
		//#region ../../../node_modules/.pnpm/gpt-tokenizer@4.0.0/node_modules/gpt-tokenizer/esm/encodingParams/p50k_base.js
		...
		//#endregion
		//#region ../../../node_modules/.pnpm/gpt-tokenizer@4.0.0/node_modules/gpt-tokenizer/esm/encodingParams/p50k_edit.js
		...
		//#endregion
		//#region ../../../node_modules/.pnpm/gpt-tokenizer@4.0.0/node_modules/gpt-tokenizer/esm/encodingParams/r50k_base.js
		...
		//#endregion
		//#region ../../../node_modules/.pnpm/gpt-tokenizer@4.0.0/node_modules/gpt-tokenizer/esm/modelParams.js
		...
		//#endregion
		//#region ../../../node_modules/.pnpm/gpt-tokenizer@4.0.0/node_modules/gpt-tokenizer/esm/GptEncoding.js
		...
		//#endregion
		//#region ../../../node_modules/.pnpm/gpt-tokenizer@4.0.0/node_modules/gpt-tokenizer/esm/bpeRanks/p50k_base.js
		const c0 = [
			"!",
			"\"",
			"#",
		...
		const bpe = c0.concat();
		c0.length = 0;
		const { decode, decodeAsyncGenerator, decodeGenerator, encode, encodeGenerator, isWithinTokenLimit, countTokens, vocabularySize, setMergeCacheSize, clearMergeCache, estimateCost } = GptEncoding.getEncodingApi("p50k_base", () => bpe);
		//#endregion
		//#region lib/types/client/estimate.js
		/**
		...
		* @module dsh-token-meter/client/estimate
		*/
		...
		function estimateBlocks(blocks) {
			...
			for (const block of blocks) switch (block.kind) {
				...
				case "image":
					output += 1;
					break;
				default: output += count(JSON.stringify(block.block));
			}
			return {
				output,
				input
		...
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
			...
			tag.dataset.plugin = "dsh-token-meter";
		...
		*/
		...
		function readBuckets(pv) {
			...
			return {
				input: i + cr + cw,
				output: Number(pv.outputTokens) || 0,
				hit: cr,
				miss: i + cw
			};
		}
		...
		function MeterPanel(props) {
			...
			const [justCalibrated, setJustCalibrated] = (0, react.useState)(false);
			const wasLive = (0, react.useRef)(false);
			const liveAcc = (0, react.useRef)({
				input: 0,
				output: 0
			});
			(0, react.useEffect)(() => {
				...
				const poll = () => {
					...
					if (blocks === null) {
						if (wasLive.current) {
							...
							setTimeout(() => {
								if (open) setJustCalibrated(false);
							}, 1e3);
						}
						wasLive.current = false;
						liveAcc.current = {
					...
					if (open) {
						setLive({
							input: liveAcc.current.input,
							output: liveAcc.current.output
						});
			...
			let allHit = 0;
			let allMiss = 0;
			if (byId !== void 0) for (const key of Object.keys(byId)) {
			...
			const fmt = (n) => Number.isFinite(n) ? n.toLocaleString() : t("noData");
				...
				children: [
					...
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [(0, react_jsx_runtime.jsx)("span", {
							...
							className: panel_module_css_default.value + (est ? ` ${panel_module_css_default.est}` : ""),
							children: fmt(inVal)
						})]
					}),
					(0, react_jsx_runtime.jsxs)("div", {
					...
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [(0, react_jsx_runtime.jsx)("span", {
							...
							className: panel_module_css_default.value,
							children: fmt(base.hit)
						})]
					}),
					(0, react_jsx_runtime.jsxs)("div", {
						className: panel_module_css_default.row,
		...
		* @module dsh-token-meter/client/settings
		*/
		function useStore(injected) {
			const [, force] = (0, react.useState)(0);
			(0, react.useEffect)(() => injected.store.subscribe(() => force((n) => n + 1)), [injected.store]);
			return injected.store.get();
		}
		/** Two/three-state option rendered as a pill of tappable blocks. */
		function Blocks(options, value, onChange) {
			return (0, react_jsx_runtime.jsx)("div", {
				className: panel_module_css_default.seg,
				children: options.map((option) => {
					const active = option.value === value;
					return (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						className: panel_module_css_default.segBtn + (active ? ` ${panel_module_css_default.segActive}` : ""),
		...
		function SettingsPanel(props) {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				className: panel_module_css_default.settings,
				children: [
					(0, react_jsx_runtime.jsx)("div", {
						className: panel_module_css_default.setTitle,
					...
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							(0, react_jsx_runtime.jsxs)("div", {
								className: panel_module_css_default.slider,
								children: [
									(0, react_jsx_runtime.jsx)("span", {
										className: panel_module_css_default.sliderLabel,
										children: "0%"
									}),
							...
							(0, react_jsx_runtime.jsxs)("div", {
								className: panel_module_css_default.sliderValue,
								children: [settings.transparent, "%"]
							})
						]
					}),
					(0, react_jsx_runtime.jsx)("div", { className: panel_module_css_default.divider }),
					...
					(0, react_jsx_runtime.jsx)("div", {
						...
						children: (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [(0, react_jsx_runtime.jsx)("button", {
								type: "button",
								className: panel_module_css_default.info,
		...
		//#endregion
		//#region lib/types/client/DisclaimerModal.js
		/**
		* Disclaimer modal: centered overlay opened from the settings ⓘ button.
		* Registered into `shell.overlay` and lives until dismissed.
		* @module dsh-token-meter/client/disclaimer
		*/
		function DisclaimerModal(props) {
			const { visible, onClose, t, subscribe } = props;
			const [open, setOpen] = (0, react.useState)(visible);
			(0, react.useEffect)(() => subscribe(() => setOpen(() => props.visible)), [subscribe, props.visible]);
			if (!open) return null;
			return (0, react_jsx_runtime.jsx)("div", {
				className: panel_module_css_default.modalBg,
				onClick: onClose,
				children: (0, react_jsx_runtime.jsxs)("div", {
					className: panel_module_css_default.modal,
					onClick: (e) => e.stopPropagation(),
					children: [(0, react_jsx_runtime.jsx)("span", {
						className: panel_module_css_default.modalClose,
						onClick: onClose,
						children: "×"
					}), (0, react_jsx_runtime.jsx)("div", {
		...
		* blocks rendering.
		* @module dsh-token-meter/client/store
		*/
		...
		*/
		...
		function makeT(getLang) {
			return (key) => {
				return (getLang() === "en" ? en : zh)[key] ?? zh[key] ?? key;
			};
		}
		...
		*/
		function apply(ctx) {
			...
			const openDisclaimer = () => {
				...
				for (const fn of [...disclaimer.listeners]) fn();
			};
			...
			ctx.slots.inject("shell.overlay", () => ctx.slots.register({
				...
				inject: () => ({
					...
					t,
					subscribe: (fn) => {
						disclaimer.listeners.add(fn);
						return () => {
							disclaimer.listeners.delete(fn);
						};
					}
				})
			}, DisclaimerModal));
